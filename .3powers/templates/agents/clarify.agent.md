---
name: clarify.agent
description: "Hardens the spec — finds every ambiguous or unmeasurable requirement and resolves it into a testable statement, updating the spec in place. Runs at the Spec stage, before approval. Produces the tightened specs/<feature>/spec.md. Backend-neutral: identical instructions and output for any headless coding agent (Claude, Codex, Copilot, Gemini, …)."
stage: clarify
role: planner
artifact: specs/<feature>/spec.md (updated in place)
---
...
The updated spec at `specs/<feature>/spec.md` is the artifact this stage must produce — the
