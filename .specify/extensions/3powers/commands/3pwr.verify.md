---
description: "Run the 3Powers deterministic gate suite and verify the signed verdict ledger for the active feature."
---
...
Run the 3Powers engine — provider-agnostic, no direct model calls:
...
1. `3pwr gate run --spec specs/<feature>/spec.md --tier <tier>` — the deterministic suite cheapest-first
   ...
   spec-conformance), emitting one normalized verdict and a signed ledger entry.
