...
| | |
|---|---|
| **Current milestone** | **v0.5 complete; v1.0 in progress** (spec §17 phasing; plans 001–029 delivered) |
...
| **Last validated** | **2026-07-05**, against [`3Powers_Spec_v0.2.md`](../specs-src/3Powers_Spec_v0.2.md) (Spec ID `3PWR`) |
...
> the requirement IDs below are the point. Last updated after **plan 029 (STEER)**.
