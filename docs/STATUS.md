...
| | |
|---|---|
| **Current milestone** | **v1.0 release candidate (`1.0.0-rc.1`)** — v0.5 complete; the v1.0 lifecycle & ecosystem slice delivered (spec §17 phasing; plans 001–033) |
...
| **Last validated** | **2026-07-08**, against [`3Powers_Spec_v0.2.md`](../specs-src/3Powers_Spec_v0.2.md) (Spec ID `3PWR`) |
...
> the requirement IDs below are the point. Last updated after **plan 033 (V1REL — the `1.0.0-rc.1` release candidate)**.
