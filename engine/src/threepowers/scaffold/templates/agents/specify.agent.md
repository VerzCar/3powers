...
stage: specify
role: planner
artifact: spec.md, flat in the engine-given feature folder under specs-src/
---
...
Write the spec as `spec.md` FLAT into the engine-given feature folder `$FEATURE_FOLDER` — when
