...
stage: clarify
role: planner
artifact: spec.md updated in place at the engine-given destination (default specs-source/<feature>/spec.md)
---
...
blocks. If the engine has given no destination, default to `specs-source/<feature>/spec.md`.
